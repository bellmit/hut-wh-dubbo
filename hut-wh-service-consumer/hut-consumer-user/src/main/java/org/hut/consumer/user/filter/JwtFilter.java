...
import org.hut.consumer.user.token.JwtToken;
...
public class JwtFilter extends BasicHttpAuthenticationFilter {
    ...
    /**
     * 重写校验逻辑
     * 检 测header里面是否包含Authorization字段即可
     * 我们在这里返回true，Controller中可以通过 subject.isAuthenticated() 来判断用户是否登入
    ...
    protected boolean executeLogin(ServletRequest request, ServletResponse response) throws Exception {
        ...
        JwtToken token = new JwtToken(authorization, host);
